...
/*        if (ownerAID > 0) {
        ...
        outPacket.encodeInt(getEliteGrade()); // -1
        if (getEliteGrade() >= 0) {
            outPacket.encodeInt(getEliteSkills().size());
            for (Tuple<Integer, Integer> skill : getEliteSkills()) {
