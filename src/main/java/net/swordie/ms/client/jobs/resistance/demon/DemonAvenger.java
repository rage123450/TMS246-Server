    ...
    public void handleAttack(Client c, AttackInfo attackInfo) {
        ...
        switch (attackInfo.skillId) {
            ...
            case DEMONIC_BLAST_ATTACK_1:
                if (tsm.getOptByCTSAndSkill(HiddenPossession, DEMONIC_FRENZY) != null) {
        ...
        switch (skillID) {
            ...
            case DEMONIC_FRENZY:
                if (tsm.hasStatBySkillId(skillID)) {
                    ...
                    tsm.putCharacterStatValue(BattlePvPHelenaMark, o1);
                }
                break;
