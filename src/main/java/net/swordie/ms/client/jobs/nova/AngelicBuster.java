...
public class AngelicBuster extends Job {
    ...
    private void trinityBuff(TemporaryStatManager tsm) {
        ...
        Option o2 = new Option();
        int amount = 1;
        if (tsm.hasStat(CharacterTemporaryStat.Trinity)) {
            amount = tsm.getOption(CharacterTemporaryStat.Trinity).mOption;
            if (amount < 3) {
                amount++;
            }
        }
        ...
        o1.tOption = 5;
        o1.mOption = amount;
        tsm.putCharacterStatValue(CharacterTemporaryStat.Trinity, o1);
        o2.nValue = (5 * amount);
        o2.nReason = TRINITY;
        o2.tTerm = 5;
    ...
    private void increaseMightyMascotSummonTerm() {
        TemporaryStatManager tsm = chr.getTemporaryStatManager();
        Option o = new Option();
        Option prevOpt = tsm.getOptByCTSAndSkill(CharacterTemporaryStat.IndieSummon, MIGHTY_MASCOT);
        SkillInfo si = SkillData.getSkillInfoById(MIGHTY_MASCOT);
        int slv = chr.getSkillLevel(MIGHTY_MASCOT);
        int termInc = si.getValue(q, slv);
        o.nValue = prevOpt.nValue;
        o.nReason = prevOpt.nReason;
        o.tTerm = (int) tsm.getRemainingTime(CharacterTemporaryStat.IndieSummon, MIGHTY_MASCOT) + termInc;
        o.summon = prevOpt.summon;
        o.setInMillis(true);
        tsm.putCharacterStatValue(CharacterTemporaryStat.IndieSummon, o, true);
        tsm.sendSetStatPacket();
    }
    ...
    public void handleSkill(Char chr, TemporaryStatManager tsm, int skillID, int slv, InPacket inPacket, SkillUseInfo skillUseInfo) {
        ...
        switch (skillID) {
            ...
            case POWER_TRANSFER:
                ...
                o1.rOption = skillID;
                o1.tOption = si.getValue(time, slv);
                tsm.putCharacterStatValue(CharacterTemporaryStat.PowerTransferGauge, o1);
                break;
            case IRON_BLOSSOM:
            ...
            case STAR_GAZER:
                ...
                o1.rOption = skillID;
                o1.tOption = si.getValue(time, slv);
                tsm.putCharacterStatValue(CharacterTemporaryStat.SharpEyes, o1); //Changed IncCriticalDamMax to SharpEyes
                o2.nOption = si.getValue(y, slv);
                o2.rOption = skillID;
                o2.tOption = si.getValue(time, slv);
                tsm.putCharacterStatValue(CharacterTemporaryStat.IncCriticalDam, o2);
                break;
            ...
            case SOUL_SEEKER_EXPERT:
                o1.nOption = 1;
                o1.rOption = skillID;
                tsm.putCharacterStatValue(CharacterTemporaryStat.AngelicBursterSoulSeeker, o1);
                break;
            case PRETTY_EXALTATION:
                ...
                tsm.putCharacterStatValue(CharacterTemporaryStat.IndieBDR, o2);
                break;
            case FINAL_CONTRACT:
                o1.nOption = si.getValue(x, slv);
                o1.rOption = skillID;
            ...
            case SUPER_STAR_SPOTLIGHT:
                ...
                o1.rOption = skillID;
                o1.tOption = si.getValue(time, slv);
                tsm.putCharacterStatValue(CharacterTemporaryStat.SpotLight, o1);
                break;
            case SPARKLE_BURST:
            ...
            case MIGHTY_MASCOT:
                ...
                summon.setMoveAbility(MoveAbility.Stop.Walk);
