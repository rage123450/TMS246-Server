    ...
    public void handleSkill(Char chr, TemporaryStatManager tsm, int skillId, int slv, InPacket inPacket, SkillUseInfo skillUseInfo) {
        ...
        switch (skillId) {
            ...
            case SAGE_WRATH_OF_GODS:
                ...
                o1.tOption = 30;
                o1.xOption = 0;
                tsm.putCharacterStatValue(CharacterTemporaryStat.SageWrathOfGods, o1);
                break;
        }
    ...
    public void handleKeyDownSkill(Char chr, int skillID, InPacket inPacket) {
        ...
        switch (skillId) {
            case DREAM_OF_SHANGRI_LA:
                ...
                o2.tTerm = 20;
                tsm.putCharacterStatValue(CharacterTemporaryStat.DreamDowon, o2);
                tsm.sendSetStatPacket();
                break;
        }
    }
...
//        chr.getScriptManager().giveAndEquip(1353800); // secondary
    ...
    private void doSageGodAssist() {
        ...
        Option o = new Option();
        int stack = 0;
        if (tsm.hasStat(CharacterTemporaryStat.SageWrathOfGods)) {
            stack = tsm.getOption(CharacterTemporaryStat.SageWrathOfGods).xOption;
            if (stack < 12) {
                stack++;
            }
            if (stack == 12) {
            ...
            o.xOption = stack;
            tsm.putCharacterStatValue(CharacterTemporaryStat.SageWrathOfGods, o);
            tsm.sendSetStatPacket();
        }
    }
