...
destinations = [
    ["Easy", 140, 272020200, 5, EventType.EArkarium, 64800000],
    ["Normal", 170, 272020210, 5, EventType.Arkarium, 64800000],
]
...
if not 272020200 <= sm.getFieldID() <= 272020210:
    ...
    dialog = "Do you want to head to '#bArkarium's Altar#k' to fight \r\n#bArkarium#k?\r\n"

    for i in range(len(destinations)):
        dialog += "#L%d##bGo to Arkarium's Altar (%s Mode) #r(Lv. %d+)#b#l\r\n" % (i, destinations[i][0], destinations[i][1])
    ...
    if sm.getParty() is None:
        ...
        sm.sendSayOkay("Please have your party leader talk to me if you wish to face #bArkarium#k.")
        sm.dispose()
