...
if sm.getFieldID() == 993073000: # Some kind of jail?
    sm.sendSayOkay("You can't leave this map.")
else:
    ...
    maps = [
        ...
        [
            [120040000, "Black Bean"], [105100100, "Balrog"], [105200000, "Root Abyss"], [211070000, "Von Leon"],
            [272020110, "Arkarium"], [401000001, "Easy Magnus"], [401060000, "Normal/Hard Magnus"],
            [270050000, "Pink Bean"], [271040000, "Cygnus"], [211041700, "Ranmaru"], [105300303, "Damien"],
            [992000000, "Dorothy"], [450007240, "Will"]
        ], # Boss Entrances
    ...
    if option == 0: # I want to go somewhere (maps)
        ...
        sm.sendSayOkay("This option currently is unavailable.")